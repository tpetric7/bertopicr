...
use_python(file.path(userprofile, "Documents/R/bertopic/bertopic4r/Scripts", required = TRUE))
# use_python("path/to/your/python/env/bertopic", required = TRUE)
# or:
# use_virtualenv("path/to/your/python/env/bertopic", required = TRUE)
...
To create an interactive 3D plot, the `visualize_documents_3d()` function can be used. This function is not implemented in the `Python` package.
...
# Show wordcloud
create_wordcloud(r.topic_model200, topic=1)
```
